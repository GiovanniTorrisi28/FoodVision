...
def classify():
    ...
    if model_choice == "ResNet18":
        ...
        model_file = os.path.join(os.getcwd(), "modelli", "resnet_finetuning_lr=0.0001", "resnet_finetuning_lr=0.0001-30.pth")
    elif model_choice == "SqueezeNet":
        model = get_squeezenet_model()
        model_file = os.path.join(os.getcwd(), "modelli", "squeezenet_finetuning_lr=0.0001", "squeezenet_finetuning_lr=0.0001-30.pth")
    elif model_choice == "EfficientNet-B0":
        model = get_efficientnet_model()
        model_file = os.path.join(os.getcwd(), "modelli", "efficientnet_finetuning_lr=0.0001", "efficientnet_finetuning_lr=0.0001-30.pth")
